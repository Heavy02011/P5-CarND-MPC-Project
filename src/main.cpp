    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          *
          JSON object send back from the simulator command server
          =======================================================
          ...
          */
          ...
          // points in cars coordinate system
          for (int i=0; i < ptsx.size(); i++) {
            // rotate car reference by 90°
          ...
          auto coeffs = polyfit(ptsx_transform, ptsy_transform, 2); // 2nd grade polynomal
          ...
          //Display the waypoints/reference line (YELLOW) in car cs
          ...
          //Display the MPC predicted trajectory (GREEN) in car cs
          ...
          cout << "steer, throttle = " << -vars[0]/deg2rad(25) << "  " << vars[1] << endl;
